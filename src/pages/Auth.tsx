    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 rounded-full gradient-primary flex items-center justify-center mb-4 fab-glow">
            <Sparkles className="w-8 h-8 text-primary-foreground" />
          </div>
          <h1 className="text-2xl font-bold font-display text-foreground">m3</h1>
          <p className="text-xs font-medium text-primary tracking-wider uppercase mb-1">Money Master</p>
